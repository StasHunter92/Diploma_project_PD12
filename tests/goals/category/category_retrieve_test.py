...
class TestCategoryRetrieveView:
    ...
    def test_active_category_retrieve_participant(self, authenticated_user, user) -> None:
        """
    ...
    # ----------------------------------------------------------------
    @pytest.mark.django_db
    def test_deleted_category_retrieve_participant(self, authenticated_user, user) -> None:
        """
