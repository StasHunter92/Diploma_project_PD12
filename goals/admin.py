...
class BoardParticipantAdmin(admin.ModelAdmin):
    ...
    fieldsets: Tuple[Tuple] = (  # type: ignore
        ("Общая информация", {"fields": ("board", "user", "role")}),
        ("Информация о дате", {"fields": ("created", "updated")}),
    )
...
class GoalCategoryAdmin(admin.ModelAdmin):
    ...
    fieldsets: Tuple[Tuple] = (  # type: ignore
        ("Общая информация", {"fields": ("user", "title")}),
        ("Статус", {"fields": ("is_deleted",)}),
        ("Информация о дате", {"fields": ("created", "updated")}),
    )
...
class GoalAdmin(admin.ModelAdmin):
    ...
    fieldsets: Tuple[Tuple] = (  # type: ignore
        ("Общая информация", {"fields": ("user", "title", "description")}),
        ("Техническая информация", {"fields": ("category", "status", "priority")}),
        ("Информация о дате", {"fields": ("due_date", "created", "updated")}),
    )
...
class GoalCommentAdmin(admin.ModelAdmin):
    ...
    fieldsets: Tuple[Tuple] = (  # type: ignore
        ("Общая информация", {"fields": ("user", "goal")}),
        ("Комментарий", {"fields": ("text",)}),
        ("Информация о дате", {"fields": ("created", "updated")}),
    )
